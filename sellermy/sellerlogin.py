...
# Force stdout to UTF-8 (so emojis won't break in Windows)
...
def login_and_save_session():
    with sync_playwright() as p:
        ...
        session_file_path = os.path.join(session_dir, "sellermylogin.json")
        ...
        print("âœ… Login session saved to sellermylogin.json")
