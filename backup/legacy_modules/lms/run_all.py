...
SHEET_URL = "https://docs.google.com/spreadsheets/d/1s5QtTQ_naNwyg4CVb2Nt1Tg0HpRGxrt11sMNMvjvYVw/edit?gid=835742641#gid=835742641"
BASE_DIR = os.path.dirname(os.path.abspath(__file__))

# Scripts and their corresponding Google Sheet tab names
scripts_to_run = [
    ("seller_login.py", None),
    (os.path.join("lms_test_scripts","test_verify_opencontact.py"), "LMS"),
    (os.path.join("lms_test_scripts", "test_verify_searchbycity.py"), "LMS"),
    (os.path.join("lms_test_scripts", "test_verify_searchbyname.py"), "LMS"),  
    (os.path.join("lms_test_scripts", "test_verify_sendmessage.py"), "LMS"),
    (os.path.join("lms_test_scripts", "test_verify_sendattachment.py"), "LMS"),
    (os.path.join("lms_test_scripts", "test_verify_setreminder.py"), "LMS"),
    (os.path.join("lms_test_scripts", "test_verify_addnotes.py"), "LMS"),
    (os.path.join("lms_test_scripts", "test_verify_viewdetailsscreen.py"), "LMS"),  
]
