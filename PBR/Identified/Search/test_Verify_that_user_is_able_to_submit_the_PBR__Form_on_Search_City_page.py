...
SEARCH_CITY_URL = (
    "https://dir.indiamart.com/search.mp?ss=chairs&search_type=p&mcatid=3712&catid=93&v=4&crs=cs-glb&cq=kolkata&cq_src=city-search_2&tags=res:RC3|ktp:N0|mtp:G|wc:1|lcf:3|cq:kolkata|qr_nm:gl-gd|cs:15041|com-cf:nl|ptrs:na|mc:3712|cat:93|qry_typ:P|lang:en|rtn:1-1-0-0-1-6-1|tyr:1|qrd:250730|mrd:250730|prdt:250730|msf:ms|pfen:1|gli:G0I0"
)
...
def run(playwright):
    ...
    for browser_name in BROWSERS:
        ...
        browser = getattr(playwright, browser_name).launch(headless=False, slow_mo=80)
        ...
        try:
            log_step("Navigate to Search City Results", lambda: page.goto(SEARCH_CITY_URL, timeout=60000))
