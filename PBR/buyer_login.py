...
def login_and_save_session():
    with sync_playwright() as p:
        ...
        session_file_path = session_dir / "pbrlogin.json"
        legacy_session_file_path = Path("/var/log/web_tester_logs/pbrlogin.json")
        ...
        print("âœ… Login session saved to pbrlogin.json")
