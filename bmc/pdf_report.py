...
# ----------------------- Google Sheet Setup ----------------------- #
SHEET_NAME = "Buyer Automation - Test Server"
WORKSHEET_NAME = "BMC"
...
pdf_file = os.path.join(session_dir, "bmc-report.pdf")
...
# Title
elements.append(Paragraph("Automation Test Report - Desktop BMC", styles['Title']))
