    ...
    with sync_playwright() as playwright:
        for browser_name in BROWSERS:
            ...
            try:
                ...
                try:
                    # Step 2: Go to Relevant BuyLeads
                        page.wait_for_selector('a:has(h5:has-text("Relevant BuyLeads"))', timeout=10000)
                        page.click('a:has(h5:has-text("Relevant BuyLeads"))')
                        log_step("Navigate to Relevant BuyLeads", "Pass", "Successfully navigated to Recent BuyLeads")
                except Exception as e:
                        log_step("Navigate to Relevant BuyLeads", "Fail", str(e))
                        return False
