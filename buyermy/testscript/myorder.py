...
def run(playwright):
    ...
    for browser_name in BROWSERS:
        ...
        log_step("Verify Navigation of Click Product of Interest", lambda: click_product_of_interest(page))
        
        log_step("Verify Navigation of Chat with Seller", lambda: chat_with_seller(page, context))
